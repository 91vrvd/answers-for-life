...
import { ArrowLeft, ArrowRight, CalendarDays, ListChecks, PenLine } from "lucide-react";
...
export function JourneyPage() {
  ...
  return <PageContainer className="journey-page">
    ...
    <section className="journey-copy"><p className="section-kicker">{isSelf ? "三种不同的靠近方式" : "两种不同的靠近方式"}</p><h1>这一次，<br />想怎样回答爱？</h1><p>可以凭第一感觉选出想做的小事，<br />也可以坐下来，认真写几句心里话。</p></section>
    <div className="journey-options">
      ...
      {isSelf && <button className="challenge-option" onClick={() => dispatch({ type: "setJourney", journey: "challenge" })}><span><CalendarDays size={23} strokeWidth={1.5} /></span><div><small>自由打卡 · 新</small><strong>30天全新自己挑战</strong><p>不用连续30天，完成顺序也由你决定</p></div><ArrowRight size={19} /></button>}
    </div>
    <p className="mode-note">没有标准进度，选择此刻适合你的方式</p>
  </PageContainer>;
}
