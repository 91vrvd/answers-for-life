...
async function exportImages(page, theme, items) {
  ...
  for (let pageIndex = 0; pageIndex < pages.length; pageIndex += 1) {
    ...
    ctx.fillStyle = "#B86F72"; ctx.font = '700 22px "PingFang SC"'; ctx.fillText("给生活的答案", 94, 86);
    ...
    ctx.fillStyle = "#6F6964"; ctx.font = '600 19px "PingFang SC"'; ctx.fillText("给生活的答案｜微信搜索同名小程序", 94, 1360);
